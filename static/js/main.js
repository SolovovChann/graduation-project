...
$('#addStudent').click(function(e){
    ...
    $.ajax({
        ...
        dataType:   'html',
        method:     'POST',
        url:        'views/ajax/student_add.php',
